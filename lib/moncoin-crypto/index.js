...
/**
 * Module of MONCoin Cryptographic Methods
 * @module Crypto
 * @class
 */
class Crypto {
...
function loadBrowserWASM () {
  ...
  try {
    const Self = window.MONCoinCrypto()
...
function loadNativeAddon () {
  try {
    const Self = require('moncoin-crypto')
...
function loadNativeJS () {
  try {
    const Self = require('./moncoin-crypto.js')()
...
function loadWASMJS () {
  ...
  try {
    const Self = require('./moncoin-crypto-wasm.js')()
